#!/usr/bin/env python3
"""Aggregate multi-seed sequence errors for refined-phase sequence experiments."""
...
from tools.train_refined_phase_sequence import (
    RefinedPhaseSequenceEncoder,
    build_phase_vocabs,
    make_window_phase_sequence_samples,
    predict_probs,
    train_model,
)
from tools.train_symbolic_classifier import canonical_label, overlap_labels, subsample_by_fraction
from tools.train_symbolic_pretrain import resolve_split_window_args, split_train_holdout
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=Path("experiments/generated/refined_phase_sequence_analysis.json"))
