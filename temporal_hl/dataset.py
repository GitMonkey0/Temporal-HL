...
class TemporalHLDataset(Dataset):
    ...
    def __getitem__(self, index: int) -> dict:
        ...
        features = np.concatenate([coords, velocity, joint_valid[..., None]], axis=-1)
        return {
            ...
            "keyframe_mask": torch.from_numpy(data["keyframe_mask"].astype(np.float32)),
        }
